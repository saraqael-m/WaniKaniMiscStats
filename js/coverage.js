...
async function kanjiListCharts() {
    ...
    jlptChart.render();
    jlptChart.updateOptions({ theme: { mode: lightMode ? 'light' : 'dark' }, chart: { background: lightMode ? '#ffffff' : '#232629' } });
    ...
    joyoChart.render();
    joyoChart.updateOptions({ theme: { mode: lightMode ? 'light' : 'dark' }, chart: { background: lightMode ? '#ffffff' : '#232629' } });
    ...
    schoolChart.render();
    schoolChart.updateOptions({ theme: { mode: lightMode ? 'light' : 'dark' }, chart: { background: lightMode ? '#ffffff' : '#232629' } });
    ...
    litChart.render();
    litChart.updateOptions({ theme: { mode: lightMode ? 'light' : 'dark' }, chart: { background: lightMode ? '#ffffff' : '#232629' } });
